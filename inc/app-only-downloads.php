...
function ecm_app_download_message_html(): string {
    ...
    <style>
        .ecm-app-dl-box{
            background:var(--ecm-bg-card,#1a1d22);
            border:1px solid var(--ecm-green-glow,rgba(156,255,0,.20));
            border-radius:var(--ecm-radius-lg,14px);
            padding:28px 24px;text-align:center;
            color:var(--ecm-white,#eef0f4);margin-bottom:18px;
            box-shadow:var(--ecm-shadow-green,0 0 24px rgba(156,255,0,.18));}
        .ecm-app-dl-box .ico{font-size:46px;line-height:1;margin-bottom:8px;}
        .ecm-app-dl-box h3{margin:6px 0 8px;color:var(--ecm-green,#9cff00);font-size:21px;}
        .ecm-app-dl-box p{margin:0 auto;max-width:520px;font-size:15px;line-height:1.7;
            color:var(--ecm-grey-light,#b8bcc8);}
        ...
        .ecm-app-dl-list li{display:flex;align-items:center;gap:10px;justify-content:space-between;
            background:var(--ecm-bg-panel,#222630);
            border:1px solid var(--ecm-border,rgba(255,255,255,.08));
            color:var(--ecm-white,#eef0f4);
            border-radius:var(--ecm-radius-md,10px);padding:13px 16px;margin-bottom:8px;}
        .ecm-app-dl-badge{background:var(--ecm-green,#9cff00);color:#0e1a10;font-weight:700;font-size:12px;
